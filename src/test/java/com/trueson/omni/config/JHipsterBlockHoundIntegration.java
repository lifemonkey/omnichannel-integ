package com.trueson.omni.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.trueson.omni.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.trueson.omni.security.DomainUserDetailsService", "createSpringSecurityUser");
